    ...
    Tables: {
      ...
      stock_items: {
        Row: {
          ...
          imei: string | null;
          has_imei: boolean;
          device_category: 'IPHONE' | 'IPAD';
          status: 'READY' | 'SERVIS' | 'KANIBAL' | 'RUSAK' | 'TERJUAL';
          count: number;
          price: number;
          cost_price: number;
      ...
      transactions: {
        Row: {
          id: string;
          type: 'Penjualan' | 'Pembelian' | 'Pembelian Pelengkap' | 'Buyback' | 'Servis' | 'Pengeluaran' | 'Tukar Tambah' | 'Pemasukan Lain' | 'Upah Servis';
          description: string;
          detail: string;
          amount: number;
          created_at: string;
