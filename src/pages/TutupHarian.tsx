...
function computeTodayFigures(
  ...
  return {
    ...
    purchaseCount: countToday(todayTx, 'Pembelian') + countToday(todayTx, 'Buyback'),
    purchaseTotal: sumToday(todayTx, 'Pembelian') + sumToday(todayTx, 'Buyback'),
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
              {[
                ...
                { label: 'Pembelian / Buyback', count: figures.purchaseCount, total: figures.purchaseTotal },
